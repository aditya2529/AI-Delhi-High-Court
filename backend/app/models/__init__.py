...
those in `backend/alembic/versions/0001_initial_schema.py`.
...
# Naming convention — must stay in sync with the Alembic migration.
NAMING_CONVENTION = {
...
from app.models.parsed_case import ParsedCase  # noqa: E402,F401
from app.models.search_request import SearchRequest  # noqa: E402,F401
from app.models.case_party import CaseParty  # noqa: E402,F401
from app.models.case_order import CaseOrder  # noqa: E402,F401
